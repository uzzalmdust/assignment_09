            ...
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 col-xl-8">
                        ...
                        <h2 class="display-4 fw-bold mt-2 mb-3">For Contact</h2>
                        <p class="lead text-muted mb-5">Please Write your messege and send me..</p>
                        <form action="#">
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-8 col-lg-6 mb-3 mb-lg-0 p-3">
                                    <input class="form-control" type="name" placeholder="Your name">
                                </div>
                                <div class="col-12 col-md-8 col-lg-6 mb-3 mb-lg-0 p-3">
                                    <input class="form-control" type="email" placeholder="Type your e-mail">
                                </div>
                                <div class="col-12 col-md-8 col-lg-12 mb-3 mb-lg-0 p-3">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Write on your messege here..."></textarea>
